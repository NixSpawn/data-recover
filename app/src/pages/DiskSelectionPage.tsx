    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-8 py-6 border-b border-border flex-shrink-0">
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold">Volume Recovery</h1>
            <p className="text-sm text-muted-foreground mt-1">
              Select a volume from the list and click the{" "}
              <span className="font-medium text-foreground">Search for lost data</span> button to start.
            </p>
          </div>
          <button
            onClick={refresh}
      ...
      {/* Footer */}
      <div className="px-8 py-4 border-t border-border flex items-center justify-between flex-shrink-0 bg-card/50">
        <button className="text-sm text-muted-foreground hover:text-foreground transition-colors underline underline-offset-2">
          Can't find a location? Please click
        </button>
        <button
